...
export function createApp(options = {}) {
  ...
  cleanup.unref();
  app.get('/api/health', (_req, res) => res.json({ ok: true, version: '1.1.0', storage: 'temporary-memory' }));
