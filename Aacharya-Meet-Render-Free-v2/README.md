...
Video classrooms for Aacharya Learning Academy, with light/dark themes, screen sharing, chat, polls, shared notes, **reusable permanent classroom links**, a **collaborative whiteboard studio**, and **attendance history**.
...
- Academy Portal opens https://aacharyalearningacademytm.onrender.com in a new tab. This is navigation, not database/account synchronization.
