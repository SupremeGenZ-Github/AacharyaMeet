# Aacharya Meet 2.0 — permanent classrooms, whiteboard studio and attendance
...
- Identity is a browser-generated participant key scoped on the server to the classroom. Different devices or cleared browser storage count separately. Names are self-reported, keys can be copied, and this is not verified student identity. There is no automatic connection to the tuition-management database; the Academy Portal remains a link.
